...
/*
	...
	*/
	...
	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
	//gluPerspective(45.0f,(GLfloat)800/(GLfloat)600,0.1f,1000000.0f);
	glOrtho(0, 480.0f, 0, 320.0f, -1000, 0);

	glViewport(0, 0, (GLsizei)480.0f, (GLsizei)320.0f); // ??
...
void checkKeyboard(float seconds)
{
	...
	if (keys[VK_SPACE] && !g_PressedShoot)
	{
		g_PressedShoot = true;
					...
					int			nCmdShow)			// Window Show State
{
	...
	if (!CreateGLWindow("NeHe's OpenGL Framework", 480, 320, 16, fullscreen))
	{
